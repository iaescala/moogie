...
c      if (modprintopt .gt. 1) then
c         write (nf1out,1001) waveop
c         do i=1,ntau
c            write (nf1out,1002) i, int(t(i)), dlog10(kaplam(i)),
c     .      dlog10(aH1(i)), dlog10(aHminus(i)), dlog10(sigH(i)), 
c     .      dlog10(aHeminus(i)), dlog10(sigHe(i)), dlog10(sigel(i)),
c     .      dlog10(sigH2(i))
c         enddo
c         write (nf1out,1003) waveop
c         do i=1,ntau
c            write (nf1out,1002) i, int(t(i)), dlog10(kaplam(i)),
c     .      dlog10(aC1(i)),  dlog10(aMg1(i)), dlog10(aMg2(i)), 
c     .      dlog10(aAl1(i)), dlog10(aSi1(i)), dlog10(aSi2(i)), 
c     .      dlog10(aFe1(i))
c         enddo
c      endif
...
c*****compute an optical depth array at this wavelength, and exit
      if (modeop .ne. 1) then
         ...
         enddo
c         if (modprintopt .gt. 1) write(nf1out,1004) (taulam(i),i=1,ntau)
         return
      endif
...
c     then exit normally
      ...
      enddo
c      write (nf1out,1004) (taucheck(i),i=1,ntau)
      return
