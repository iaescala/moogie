...
c            write (nf1out,1001) gnature, gstark, gvander,
c     .                          gammadamp, a(j,i)             
         enddo                                                
         return
...
c            write (nf1out,1001) gnature, gstark, ghelium, ghydro,
c     .                          gammadamp, a(j,i), avander
         enddo
         return
...
c         write (nf1out,1002) iwave
         do i=1,ntau
            ...
            gvander = 17.0*unsold**0.4*v1**0.6*nhtot(i)       
            avander = gvander*wave1(j)*1.0d-8/(12.56636*dopp(j,i))  
c            write (nf1out,1001) gnature, ghelium, ghydro,
c     .                          gammadamp, a(j,i), avander
         enddo
         return
...
c         write (nf1out,1005) iwave
         do i=1,ntau
            ...
            gammadamp = gnature
            a(j,i) = gammadamp*wave1(j)*1.0e-8/(12.56636*dopp(j,i))
c            write (nf1out,1001) gnature, gammadamp, a(j,i)
         enddo
         return
...
c         write (nf1out,1003) iwave
         do i=1,ntau
            ...
            a(j,i) = gammadamp*wave1(j)*1.0e-8/(12.56636*dopp(j,i))
            avander = gvander*wave1(j)*1.0d-8/(12.56636*dopp(j,i))  
c            write (nf1out,1001) gnature, gcoll, gammadamp, 
c     .                          a(j,i), avander
         enddo
         return
