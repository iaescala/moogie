      subroutine sourcefunc_scat_cont(niter_cont)
c*************************************************************************
...
c          write (0,'(A,F12.5,1X,1p7e10.2,1X,I3,1X,I3)')           
c     >      'Maximum number of iterations exceeded : wave, q_max= ',
c     >      wave, q_max, i_max, ntau
          niter_cont = niter_cont + 1
